...
New-AzureResourceGroupDeployment -ResourceGroupName $rgName -Name TestDeploy -vmName $vmName -networkInterfaceId $nic.Id -adminUserName 'dennis' -TemplateFile .\150821-vmTemplate.e6eb7a1d-dfac-4372-9e07-b1bc51f6ca3e.json
